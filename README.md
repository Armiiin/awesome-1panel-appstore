...
**@pooneyy** **你是有多不要脸，还继续从这个仓库里偷，docker-compose我用AI辅助写的，你自己能写出一摸一样的？**

- 非官方，第三方应用商店
- 不对任何原始镜像的有效性做出任何明示或暗示的保证或声明，安全性和风险自查
- 个人仓库，可以Fork后自行更新，但是严谨未经授权，私自合并发布 
- 以下为黑名单
- **@pooneyy** 打着开源的名义，未经许可，私自合并，不劳而获！！！
经过沟通要求其删除合并的应用，结果是删除本项目的贡献，删除issue，不删除合并的应用，且依旧在持续持续抄袭本项目中的应用，极其不尊重他人的劳动成果！
（我觉得我要求不算过分吧，删除合并应用，不再继续抄袭，可以接受移除贡献名单。黑名单不删除，除非满足上述要求）
