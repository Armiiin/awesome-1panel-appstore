...
### ⚠️ 仓库申明
**@pooneyy** **你是有多不要脸，还继续从这个仓库里偷，docker-compose我用AI辅助写的，你自己能写出一摸一样的？**  **https://github.com/pooneyy/1Panel-Appstore**

- 非官方，第三方应用商店
- 不对任何原始镜像的有效性做出任何明示或暗示的保证或声明，安全性和风险自查
- 个人仓库，未经授权，禁止其他仓库私自合并 
- 以下为黑名单
- **@pooneyy** 打着开源的名义，未经许可，私自合并，不劳而获！！！
经过沟通要求其删除合并的应用，结果是删除本项目的贡献，删除issue，不删除合并的应用，极其不尊重他人的劳动成果，严重影响继续更新的动力！！
